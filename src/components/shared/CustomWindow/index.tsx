...
import {setLabelSize,setLabelAutoposition} from '../../../store/sideBar/labelSlice/AllLabelSlice';
...
const CustomWindow = forwardRef((props:CustomWindowProps, ref:any) => {
    ...
    useEffect(() => {
        ...
        dispatch(setWindowAnchor({uid,anchor:props.anchor ? props.anchor : [0,0]}));
    ...
    useEffect(() => {
        const toggleVisibility = (v:boolean) => {
            dispatch(setHiddenState({uid, isHidden: !props.visible ? true  : false}));
        }
    ...
    },[window?.isEditMode, window?.isHidden])
    ...
    return (
        <>
            ...
            onDragStop={(e, d) => {
                ...
                //         break;
                // }
                dispatch(setWindowPostionHandler({uid,anchor:props.anchor? props.anchor : [0,0],pos:[d.x,d.y], undoable: true}));
                //dispatch(setLabelAutoposition({labelId:uid,isAutoposition:true}));
                if(props.onDragStop)
            ...
            onResizeStop={(e, direction, ref, delta, position) => {
                ...
                dispatch(setLabelSize({labelId:uid,size:[ref.offsetWidth,ref.offsetHeight - titleBarHeight]}));
