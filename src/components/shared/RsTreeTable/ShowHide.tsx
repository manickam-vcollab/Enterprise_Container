...
const VisiblilityIcon = (props:any) => {
    ...
    if(props.visibility === true){
        return (
            <IconButton style={props.style} size='small' onClick = {(event: React.MouseEvent<HTMLButtonElement>) =>{event.stopPropagation(); props.onClick(false,props.node, true)}}>
        ...
        return (
            <IconButton style={props.style} size='small' onClick = {(event: React.MouseEvent<HTMLButtonElement>) => {event.stopPropagation();props.onClick(true,props.node, true)}}>
